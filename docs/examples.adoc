...
=== Using the component subcommand

include::examples/component_list.adoc[]

include::examples/component_folders.adoc[]
...
[IMPORTANT]
====
There are two different version checks that are performed by the Stacks CLI when using a .NET project.
