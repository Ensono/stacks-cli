...
:example_project_src_url: https://github.com/my-org/my-webapi
...
|===
| Name | Value | Description
| framework | `{example_dotnet_framework}` | Framework being used, e.g. `dotnet`, `java` or `infra`
...
|===
| Name | Value | Description
| framework | `{example_java_framework}` | Framework being used, e.g. `dotnet`, `java` or `infra`
