...
|`--clobber` | AMIDOSTACKS_CLOBBER | Delete existing project directories when creating new ones

This is a destructive operation and will result in existing projects being deleted in their entirety if there is a clash in the path | false | 
|===
