...
Create a project that can deploy an Azure Platform Landing Zone for Management.
...
Create a project that can deploy an Azure Platform Landing Zone for Connectivity, using a Hub and Spoke network topology.
...
Create a project that can deploy an Azure Platform Landing Zone for Connectivity, using a Virtual WAN network topology.
...
Create a project that can deploy an Azure Platform Landing Zone for Identity.
