...
// TestInteractiveMode sets up the test by running the interactive command of the Stacks CLI
...
func (suite *InteractiveSuite) TestInteractiveMode() {
	...
	cp.Expect("Which option of the framework do you require?")
...
// TestInteractiveModeInfra sets up the test by running the interactive command of the Stacks CLI
// It will set the output to the cmdOutput
// The Go-Expect library is used to test the interactiveness
func (suite *InteractiveSuite) TestInteractiveModeInfra() {
	...
	cp.Expect("What framework should be used for the project?")
	cp.SendLine("infra")
	cp.Expect("Which type of infrastructure is required?")
	cp.SendLine("")
	cp.Expect("Which version of the framework option do you require?")
	cp.SendLine("")
	cp.Expect("Please select the source control system being used")
